...
public class ResortServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            jsonResponse.addProperty("time", "Resort" + resortID); // Replace with actual resort name if available
    ...
    private boolean isUrlValid(String[] urlParts) {
        ...
        try {
            ...
            if (!urlParts[4].equals("day")) return false;
    ...
    private int getUniqueSkiers(int resortID, int seasonID, int dayID) throws Exception {
